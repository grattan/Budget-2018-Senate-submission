...
it will cost approximately 40\% in each year thereafter.\footnote{Based on Grattan analysis: see \Vref{fig:1} above.}
...
At present, the top 20 per cent of income earners -- who earn 51~per~cent of taxable income -- pay 68~per~cent per cent of income tax. As shown in \Vref{tbl:1}, without changes to income tax rates, bracket creep will make the system \emph{less} progressive.

\begin{table}
\caption{Progressivity of proposal to personal income tax}\label{tbl:1}
% latex table generated in R 3.5.0 by xtable 1.8-2 package
% Thu May 31 08:09:26 2018
...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
\includegraphics[width=4.47222in,height=2.92631723826715in]{atlas/unnamed-chunk-1-1} 
